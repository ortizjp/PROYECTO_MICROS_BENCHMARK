...
section .data
        ...
        scale: equ 0x10000 ;este numero va a ser util para calcular e$
...
_start:
         ...
         mov rdi, resultado ;Se pasa la direccion de resultado a$
         mov rax, 0x63 ;Se carga 99 decimal en rdi, que equivale$
         syscall ;se llama al sistema

_stop1:

;De acuerdo a la estructura de datos que retorna sysinfo, el $
;espacio en memoria corresponde a CPU Load/min
;Se utilizara este parametro para el calculo del porcentaje d$

         mov rbx,[resultado+8] ;Movemos el contenido de la varibl$
_stop2:


;Ahora se procedera a realizar la division
;Para ello se necesita que el dato de 64 bits se divida en dos
;Los 32bits de la  parte superior iran a EBX y los  inferiore$
